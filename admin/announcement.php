...
include "../config.php";
    ...
    $userid = $_SESSION['id']; 
        ...
        $movequery = "SELECT * FROM announcement WHERE isactive='1'  ORDER BY date ASC ";
         $result = mysqli_query($con, $movequery);

    if (isset($_POST['but_submit'])) {
        
        $details = mysqli_real_escape_string($con, $_POST['anno']);

        if (empty($details)) { array_push($errors, "Announcement is required"); }
        

        if (count($errors) == 0) {
        

         $query334 = "INSERT INTO announcement (annodetail, adminid, isactive)
              VALUES('$details', '$userid', '1')";
         mysqli_query($con, $query334);
         header('location: home.php');
         }
     }


     if (isset($_POST['but_submitdelete'])) {

            $selectOption = $_POST['annodel'];
            
            $updatequery = "UPDATE announcement SET isactive = '0' WHERE announcementid='$selectOption'";
...
<head>
        ...
        <title>Daloglu Apartment - Add Expense Page</title>
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Create a Announcement</h3></div>
                                    <div class="card-body">
                                        <form method="post" action="" id="form1">
                                            <?php include('errors.php'); ?>
                                             <div class="form-group">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputUsername">Announcement Details</label>
                                            <textarea  class="form-control" name="anno" id="form1" rows="5" placeholder="Enter Details"></textarea>
                                            </div>
                ...
                <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Delete a Announcement</h3></div>
                                    <div class="card-body">
                                        <form method="post" action="">
                                         <div class="form-group">
                                     <label for="c-form-profession">
                                         <span class="label-text">Select a Announcement to Delete</span> 
                                         <span class="contact-error"></span>
                                     </label>
                                 <select name="annodel" class="c-form-profession form-control" id="c-form-profession">
                                    <?php
                         ...
                         <input type="submit" class="btn btn-primary btn-block" value="Confirm" name="but_submitdelete" id="but_submit" href="home.php"/>                            
                    </form>
                </main>
